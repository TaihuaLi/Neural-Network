...
def train(train_x, train_y, epoch = 1, eta=0.1, stride=1, poolind=2, poolme='max', act=sigmoid, actprime =sigmoid_prime):
    ...
    for iteration in range(epoch):     
        ...
        print 'For epoch', str(iteration+1), ' cost:', str(error), ' accuracy:', str(accuracy), ' correct:', str(accurate), '/', str(len(truth)), ' time spent: %.2f'%round(time_spent,2),'seconds'                
